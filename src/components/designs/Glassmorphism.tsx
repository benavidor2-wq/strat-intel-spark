        ...
        {selectedItem && (
          <>
            ...
            <motion.div
              ...
              transition={{ duration: 0.2 }}
              className="fixed left-1/2 top-1/2 z-50 flex max-h-[calc(100vh-4rem)] w-[min(920px,calc(100vw-4rem))] -translate-x-1/2 -translate-y-1/2 flex-col overflow-hidden rounded-2xl border border-border bg-card text-card-foreground shadow-2xl"
            >
              {/* Header */}
