        ...
        >
          ...
          <div className="flex-1 min-h-0 w-full max-w-[1600px] mx-auto px-6 pt-3 pb-2 grid grid-cols-3 auto-rows-fr gap-3 overflow-hidden">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
              ...
              <div className="absolute top-3 right-3 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white shadow-md" style={{ backgroundColor: purple }}>3</div>
              <div className="flex items-center gap-2 mb-2">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.3 }}
              ...
              <div className="absolute top-3 right-3 w-7 h-7 rounded-full flex items-center justify-center text-xs font-bold text-white shadow-md" style={{ backgroundColor: purple }}>2</div>
              <div className="flex items-center gap-2 mb-2">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }}
              ...
              <div className="flex items-center gap-4 mb-2">
                ...
                <div className="flex items-center gap-1 ml-auto">
                  <span className="text-[9px] font-mono font-bold" style={{ color: purple }}>${(spendingTrends[spendingTrends.length - 1].costs / 1000000).toFixed(1)}M</span>
                ...
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={spendingTrends} margin={{ top: 4, right: 4, bottom: 0, left: 4 }}>
                    ...
                    <RechartsTooltip
                      ...
                      formatter={(value: number) => [`$${(value / 1000000).toFixed(2)}M`, "Total Spend"]}
                      labelStyle={{ fontSize: 9, color: "#9ca3af" }}
                    />
                    <Area type="monotone" dataKey="costs" stroke={purple} fill="url(#cc-mini-cost)" strokeWidth={1.5} />
                  </AreaChart>
                </ResponsiveContainer>
              </div>
            </motion.div>
